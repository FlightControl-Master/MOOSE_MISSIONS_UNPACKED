...
do
  ...
  local EngineersCargoGroup = CARGO_GROUP:New( EngineersGroup, "Engineers", "Engineers", 500 )
  ...
  local WorkersCargoGroup = CARGO_GROUP:New( WorkersGroup, "Workers", "Workers", 500 )
  ...
  WorkersCargoTransportTask:AddDeployZone( ZONE_POLYGON:New( "Deploy Zone Alpha", GROUP:FindByName("DeployZone Alpha") ) )
