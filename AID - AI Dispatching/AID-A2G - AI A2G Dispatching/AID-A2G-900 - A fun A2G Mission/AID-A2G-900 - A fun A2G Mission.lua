...
A2G_Blue:SetDefenseRadius( 70000 ) -- in meters
A2G_Blue:SetDefenseReactivityHigh() -- we engage almost immediately

A2G_Blue:SetSquadron( "SQ-1", AIRBASE.Caucasus.Gudauta, { "A2G-DEFENSE-AH-64D-ROCKETS", "A2G-DEFENSE-AH-64D-HELLFIRES" }, 6 )
...
A2G_Blue:SetSquadronBai( "SQ-2", 600, 900, 1000, 2000 )
